<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lessons.aspx.cs" Inherits="ADVANCEDBCW.Webforms.Lessons" %>
...
<body>
    ...
    <asp:HyperLink runat="server" NavigateUrl="~/Dashboard.aspx" CssClass="btn btn-dark">
        <i class="mdi mdi-arrow-left"></i> Back to Dashboard
         ...
         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="LESSON_NO,COURSE_ID" DataSourceID="SqlDataSource1"  CssClass="table table-striped table-bordered table-hover" HeaderStyle-BackColor="Red" HeaderStyle-ForeColor="White">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;LESSON&quot; WHERE &quot;LESSON_NO&quot; = :LESSON_NO AND &quot;COURSE_ID&quot; = :COURSE_ID" InsertCommand="INSERT INTO &quot;LESSON&quot; (&quot;LESSON_NO&quot;, &quot;LESSON_TITLE&quot;, &quot;LESSON_DESCRIPTION&quot;, &quot;COURSE_ID&quot;) VALUES (:LESSON_NO, :LESSON_TITLE, :LESSON_DESCRIPTION, :COURSE_ID)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;LESSON&quot;" UpdateCommand="UPDATE &quot;LESSON&quot; SET &quot;LESSON_TITLE&quot; = :LESSON_TITLE, &quot;LESSON_DESCRIPTION&quot; = :LESSON_DESCRIPTION WHERE &quot;LESSON_NO&quot; = :LESSON_NO AND &quot;COURSE_ID&quot; = :COURSE_ID">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="LESSON_DESCRIPTION" Type="String" />
                    <asp:Parameter Name="COURSE_ID" Type="String" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="LESSON_TITLE" Type="String" />
            ...
            <asp:FormView ID="FormView1" runat="server" DataKeyNames="LESSON_NO,COURSE_ID" DataSourceID="SqlDataSource1">
